...
const Hero = () => {
  return (
    <Container id="hero">
      <Slide in={true} easing={"ease"} direction="right" timeout={2500}>
        <MeetText>Nice to meet you!</MeetText>
      </Slide>
      <NameContainer>
      ...
      <Slide in={true} direction="left" timeout={2500}>
        <Devtext>a web developer</Devtext>
      </Slide>
      ...
      <Fade in={true} timeout={5500}>
        <Flower
          ...
          viewBox="-46.3 -46.3 555.59 555.59"
          enableBackground="new 0 0 462.986 462.986"
          transform="rotate(45)"
          stroke="#4a3d615c"
          strokeWidth="0.00462986"
        >
